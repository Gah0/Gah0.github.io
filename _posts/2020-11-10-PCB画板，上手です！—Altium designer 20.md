...
> 电路原理图是实现你的作品的原理方法，把所有元件连好导线就可以了，缺少的元件都需要自己画或下载。

**新建PCB图 (PCB)**

**新建PCB元件库 (PCB Library)**

> PCB，可以画出你需要电路板形状，缺乏的元件的都要自己画或者下载。

![1](/Gah0.github.io/images/20201110/1.png)
...
![2](/Gah0.github.io/images/20201110/2.png)
...
![淘宝的微动开关](/Gah0.github.io/images/20201110/淘宝的微动开关.png)

> 以下为**微动开关**的PCB封装，在Top Overlay层绘画，以下为四个过孔与四根直线，打板后，直线部分与数字会变成白色线条和注释，以下的过孔应该使用焊盘，此外，这个封装的焊盘直径似乎有点小。

![PCB封装重新画](/Gah0.github.io/images/20201110/PCB封装.jpg)

这次的电路设计，电路所需的主要的PCB封装是LED过孔，微动开关，排母过孔，滑动变阻器过孔，8PIN（NE555）, 16 PIN（CD4017）, 18PIN （LM3914）DIP底座

![PCB封装基底座](/Gah0.github.io/images/20201110/PCB封装基底座.png)
...
![PCB元件与层](/Gah0.github.io/images/20201110/PCB元件与层.png)
...
![PCB层](/Gah0.github.io/images/20201110/PCB层.png)

> 以下为存放LED灯的过孔，孔径2.54mm，孔距1mm，基本上所有焊接洞洞板都是这个数据。
>
> 过孔是错误的，实际上要使用焊盘，请注意。

![更改单位](/Gah0.github.io/images/20201110/更改单位.png)
...
![导入PCB封装](/Gah0.github.io/images/20201110/导入PCB封装.png)
...
![生成PCB](/Gah0.github.io/images/20201110/生成PCB.png)
...
![QQ截图20201016113551](/Gah0.github.io/images/20201110/QQ截图20201016113551.png)
...
![交叉工具联合](/Gah0.github.io/images/20201110/交叉工具联合.png)
...
![设计规则检查器](/Gah0.github.io/images/20201110/设计规则检查器.png)
