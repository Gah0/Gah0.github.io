...
> 胆子大去学校多媒体室找台性能好的电脑编译，安装虚拟机，特别是做视频剪辑的那种。
...
> 我看过一个开发者的做法，我感觉很妥当，能保持内核代码纯洁和性能，减少底层无用代码，把caf的tag先克隆下来，然后再cherry-pick小米的提交，把该手机驱动无关的部分剔除，将有关驱动逐个合并到caf tag上。类似于[我对小米4c的变基操作][21]。然后再盖上当前linux-stable最新版本3.10.108...其他手机同理！
