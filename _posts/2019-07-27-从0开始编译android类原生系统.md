...
看清楚自己手机设备是使用什么平台的处理器，例如我的小米9se为高通712，想要获取qcacld-3.0的驱动，那么就在源码branch或tag页面使用
...
----------
  ...
  [10]: https://source.codeaurora.org/quic/la/platform/vendor/qcom-opensource/wlan/qcacld-3.0/
